...
def main():
    ...
    _, fi, r2 = RFregression(X_train=train_dataset_beta, 
                                 y_train=train_dataset["pheno"]["Age"].values,
...
#     with open("results/globalCpGs/prediction/age/globalCpGs_regressionBootstrap_r2.pkl", "wb") as f: pickle.dump(dic_bootstrap, f)
